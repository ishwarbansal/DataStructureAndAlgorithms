...
public class ShortestCommonSubSequence {
	...
	int[][] dp;
	public ShortestCommonSubSequence(int st1Length, int st2Lenght) {
	...
	public static void main(String[] args) {
		...
		ShortestCommonSubSequence longestCommonSubSequence = new ShortestCommonSubSequence(st1.length(), st2.length());
		
		int result = longestCommonSubSequence.getLongestCommonSubSequenceUsingRecurssion(st1, st2, st1.length(), st2.length());
		int finalResult = st1.length() + st2.length() - result;
		System.out.println("getLongestCommonSubSequenceUsingRecurssion " + finalResult);
		
		result = longestCommonSubSequence.getLongestCommonSubSequenceUsingBottomUp(st1, st2, st1.length(), st2.length());
		finalResult = st1.length() + st2.length() - result;;
		System.out.println("getLongestCommonSubSequenceUsingBottomUp " + finalResult);
