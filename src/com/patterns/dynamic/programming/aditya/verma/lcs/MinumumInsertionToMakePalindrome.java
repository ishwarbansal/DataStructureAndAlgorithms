...
public class MinumumInsertionToMakePalindrome {
	
	int[][] dp;
	public MinumumInsertionToMakePalindrome(int st1Length, int st2Lenght) {
...
//				}
	...
	public static void main(String[] args) {
		...
		MinumumInsertionToMakePalindrome longestCommonSubSequence = new MinumumInsertionToMakePalindrome(st1.length(), st2.length());
		
		int result = longestCommonSubSequence.getLongestCommonSubSequenceUsingRecurssion(st1, st2.toString(), st1.length(), st2.length());
		int insertion = st1.length() - result;
		System.out.println("getLongestCommonSubSequenceUsingRecurssion Insertion " + insertion);
		
		result = longestCommonSubSequence.getLongestCommonSubSequenceUsingBottomUp(st1, st2.toString(), st1.length(), st2.length());
		insertion = st1.length()-result;
		System.out.println("getLongestCommonSubSequenceUsingBottomUp Insertion " + insertion);
