package com.patterns.two.heap;

import java.util.PriorityQueue;

public class MaximizeCapital {

	public static int findMaximumCapital2(int[] capital, int[] profits, int numberOfProjects, int initialCapital) {
	...
	public static void main(String[] args) {
		int result = MaximizeCapital.findMaximumCapital2(new int[] { 0, 1, 2 }, new int[] { 2, 6, 8 }, 2, 1);
